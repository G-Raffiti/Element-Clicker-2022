...
#pragma warning restore 0414
        ...
        public static implicit operator Dictionary<TKey, TValue>(GenericDictionary<TKey,TValue> generic)
        {
            Dictionary<TKey, TValue> result = new Dictionary<TKey, TValue>();
            foreach (TKey key in generic.Keys)
            {
                result.Set(key,generic[key]);
            }
